"""
Django settings for zhaochy_cn project.
...
SECRET_KEY = '*-+e$ddcg6ki2@@li+5$*5aal6n_c)80**%0of&5*fll+=6_j6'

# SECURITY WARNING: don't run with debug turned on in production!

if socket.gethostname() == 'zhaochy-laptop':
    DEBUG = True
else:
    DEBUG = False
